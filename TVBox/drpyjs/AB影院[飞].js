var rule = {
    ...
    二级:{
    	"title":"h3&&Text;.stui-content__detail p:eq(0)&&Text",
    	"img":".lazyload&&data-original",
    	"desc":";;;.stui-content__detail p:eq(1)&&Text;.stui-content__detail p:eq(2)&&Text",
    	// "content":".stui-content__detail p:eq(5)&&Text",
    	"content":".stui-content__desc:eq(0)&&Text",
    	"tabs":".stui-pannel__head.clearfix&&h3",
    	"lists":".stui-content__playlist.clearfix:eq(#id) a"
	},
