...
class Spider(Spider):  # 元类 默认的元类 type
	...
	def homeVideoContent(self):
		rsp = self.fetch("https://www.zxzj.pro/")
	...
	def categoryContent(self,tid,pg,filter,extend):
		...
		suffix = '-'.join(params)
		url = 'https://www.zxzj.pro/vodshow/{0}.html'.format(suffix)
		rsp = self.fetch(url)
		root = self.html(rsp.text)
		aList = root.xpath("//div[@class='stui-vodlist__box']/a")
		videos = []
	...
	def detailContent(self,array):
		tid = array[0]
		url = 'https://www.zxzj.pro/detail/{0}.html'.format(tid)
		rsp = self.fetch(url)
		root = self.html(rsp.text)
	...
	def searchContent(self,key,quick):		
		url = 'https://www.zxzj.pro/index.php/ajax/suggest?mid=1&wd={0}'.format(key)
		# getHeader()
		rsp = self.fetch(url)
	...
	config = {
		"player": {"line5":{"show":"播放线路5","des":"","ps":"0","parse":""},"line4":{"show":"播放线路4","des":"","ps":"0","parse":""},"lep":{"show":"播放线路3","des":"","ps":"0","parse":""},"kuake":{"show":"夸克网盘","des":"","ps":"0","parse":""},"xunleiyp":{"show":"迅雷云盘","des":"","ps":"0","parse":""},"yunpan":{"show":"百度网盘","des":"","ps":"0","parse":""},"dpp":{"show":"dp播放","des":"","ps":"0","parse":""},"ck":{"show":"ck播放","des":"","ps":"0","parse":""},"ty2":{"show":"播放线路2","des":"","ps":"0","parse":""},"ty189":{"show":"播放线路1","des":"","ps":"0","parse":""}},
	...
	def playerContent(self,flag,id,vipFlags):
		...
		scriptRsp = self.fetch(scriptUrl,self.header)
